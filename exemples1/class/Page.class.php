 ...
 */
	...
	function menuPrincipal($typeMenu){
		...
		switch ($typeMenu){
			...
			break;
			default:
				$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/menu_".$typeMenu.".php";
			break;
		}
	...
	function information(){
		...
		$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/information.tpl.php";
		if(is_file($this->_arbo."themes/".$GLOBALS['themes']."/templates/".$contenu->getRubrique()."/information.tpl.php")){
			$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/".$contenu->getRubrique()."/information.tpl.php";
		}
	...
	function menu2(){
		...
		if(is_file($this->_arbo."themes/".$GLOBALS['themes']."/templates/".$contenu->getRubrique()."/menu2.tpl.php")){
			$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/".$contenu->getRubrique()."/menu2.tpl.php";
		}else{
			$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/menu2.tpl.php";
		}
	...
	function pageBas($rubrique, $typePiedpage){
		...
		if($typePiedpage == 'popup'){		
			if(is_file($this->_arbo."themes/".$GLOBALS['themes']."/templates/".$rubrique."/piedpagepop.php")){
				$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/".$rubrique."/piedpagepop.php";
			}else{
				$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/piedpagepop.tpl.php";
			}
		}else{
			if(is_file($this->_arbo."themes/".$GLOBALS['themes']."/templates/".$rubrique."/piedpage.tpl.php")){
				$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/".$rubrique."/piedpage.tpl.php";
			}else{
				if(is_file($this->_arbo."themes/".$GLOBALS['themes']."/templates/piedpage_".$_SESSION['lang'].".tpl.php")){
					$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/piedpage_".$_SESSION['lang'].".tpl.php";
				}else{
					$file = $this->_arbo."themes/".$GLOBALS['themes']."/templates/piedpage.tpl.php";
				}
			}
		}
