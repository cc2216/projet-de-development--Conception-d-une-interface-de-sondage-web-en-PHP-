...
$var1=$bdd->prepare('INSERT INTO personne(prenom,nom,sexe,nationalite,date_naissance,mail,materiel) VALUES(:prenom,:nom,:sexe,:nationalite,:date_naissance,:mail,:materiel)');
$var1->execute(array(
...
$_SESSION['id_personne']=$var3['id'];	
	 ...
	 header('Location: http://localhost/gestion/templates/tests/miseengarde.php');
