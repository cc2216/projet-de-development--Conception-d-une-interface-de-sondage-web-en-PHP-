...
$var1=$bdd->prepare(' INSERT INTO test_personne(id_test,id_son,test_representativite_N1,test_representativite_N2,test_representativite_N3,test_representativite_N4,test_representativite_N5) VALUES(:id_test,:id_son,:test_representativite_N1,:test_representativite_N2,:test_representativite_N3,:test_representativite_N4,:test_representativite_N5)'); 
$var1->execute(array(
